...
/*   Updated: 2022/12/16 15:39:51 by hcremers         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		std::cout << "vct1[0]	\u001b[16G= " << vct1[0] << std::endl;
		...
		std::cout << "vct1[1]	\u001b[16G= " << vct1[1] << std::endl << std::endl;
		...
		for (size_t i = 0; i < vct1.size(); i++)
			std::cout << "vct1[" << i << "]\u001b[16G= " << vct1[i] << std::endl;
