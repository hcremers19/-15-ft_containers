...
/*   Updated: 2022/11/18 12:19:46 by hcremers         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class vector
	{
		...
		public:
			...
			------------------------------------------------------------------------ */
			vector(const allocator_type& alloc) : _container(NULL), _size(0), _capacity(0), _alloc(alloc)
				{return ;}
			...
			Source: https://cplusplus.com/reference/vector/vector/vector/
			------------------------------------------------------------------------ */
			vector(size_type n, const value_type& val, const allocator_type& alloc) : _size(n), _capacity(n), _alloc(alloc)
			{
				if (n < 0)
			...
			vector(InputIterator first, InputIterator last, const allocator_type& alloc) : _alloc(alloc)
			{
