...
/*   Updated: 2022/11/17 19:10:11 by hcremers         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	vector<T, Alloc>::vector(const allocator_type& alloc) : _container(NULL), _size(0), _capacity(0), _alloc(alloc)
		{return ;}
	...
	template<typename T, class Alloc>
	template<class InputIterator>
	vector<T, Alloc>::vector(InputIterator first, InputIterator last, const allocator_type& alloc) : _alloc(alloc) // typename enable_if<!is_integral<InputIterator>::value>::type *dummy = NULL
	{
	...
	template<typename T, class Alloc>
	template<class InputIterator>
	void												vector<T, Alloc>::assign(InputIterator first, InputIterator last) // typename enable_if<!is_integral<InputIterator>::value>::type *dummy = NULL
	{
	...
	template<typename T, class Alloc>
	template<class InputIterator>
	void												vector<T, Alloc>::insert(iterator position, InputIterator first, InputIterator last) // typename enable_if<!is_integral<InputIterator>::value>::type *dummy = NULL
	{
		size_type	pos = ft::distance(begin(), position);
